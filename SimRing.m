function speed = SimRing(wL, showMovie, DistanceCM, NumberOfBeats, Pacemaker1, Pacemaker2, Ip1, Ip2, wLP1, wLP2, Obstacle, ObstacleWidth, ObstacleTime);
...
% 
% 
% endDistance = -abs(lastPeak-firstPeak-round(Length/2))+round(Length/2);
