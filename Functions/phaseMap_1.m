function [phaseMap] = phaseMap_1(SF2)
...
Period = 1/PeakFreq;
delay = floor(Period/4);  %Delay is normally given a value that is 1/4 of the Period. For the time being, I've given it an arbitrary value.
