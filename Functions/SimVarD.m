function m = SimVarD(nameWithoutExtension, ObstacleX, ObstacleY, ObstacleRadius, ObstacleTime, PacemakerX, PacemakerY, NumberOfBeats);
...
tic
[m, Toff] = px_ch_VarD(Nt, dx, dt, D, wH, wLP, pon, poff, pdx, pdy, nBeats, size(PosX,1), PosX, PosY, NoiseSignal, NoiseRecord, size(PosXMod,1), PosXMod, PosYMod, MapModTime, VarD, VarDMod);
toc
