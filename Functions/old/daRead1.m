function [B,A,M,N,NumFrames,NumCols,NumRows,FrameInt,AcquisitionRatio,ibis,ActMap] = daRead1(daFile,XCoord,YCoord)
...
plot(Times,A);hold on;plot(Times,B,'r','linewidth',2);hold off;
