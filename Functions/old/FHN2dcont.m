...
lx=200; %with dx-0.02cm this is about 4cmX4cm of tissue.
...
newplot
subplot(2,3,1); surface(v(:,:,3)); %plot(1:lx,v(10,:,3)); %; %check out in space @ timesteps ______
caxis([-1 1])
shading interp
colormap(jet)
subplot(2,3,2); surface(v(:,:,4)); %plot(1:lx,v(10,:,4)); %
caxis([-1 1])
shading interp
colormap(jet)
subplot(2,3,3); surface(v(:,:,5)); %plot(1:lx,v(10,:,5)); %;
caxis([-1 1])
shading interp
colormap(jet)
subplot(2,3,4); surface(w(:,:,3)); %plot(1:lx,w(10,:,3)); %
caxis([-1 1])
shading interp
colormap(jet)
subplot(2,3,5); surface(w(:,:,4)); %plot(1:lx,w(10,:,4)); %
caxis([-1 1])
shading interp
colormap(jet)
subplot(2,3,6); surface(w(:,:,5)); %plot(1:lx,w(10,:,5)); %
caxis([-1 1])
shading interp
colormap(jet)
colorbar('north')
