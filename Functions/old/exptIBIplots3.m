...
allIBIpix1=[spont1_IBIpix1; cont1_IBIpix1; drug1_IBIpix1; drug2_IBIpix1; drug3_IBIpix1; drug4_IBIpix1];
...
title('IBIs for 08/04/09 dish4 at pix1', 'Fontsize',14)
ylabel('IBI [s]')
...
allIBIpix2=[spont1_IBIpix2; cont1_IBIpix2; drug1_IBIpix2; drug2_IBIpix2; drug3_IBIpix2; drug4_IBIpix2];
...
title('IBIs for 08/04/09 dish4 at pix2', 'Fontsize',14)
ylabel('IBI [s]')
xlabel('beat number analyzed')
ylim([0 2.5]);
...
allIBIpix3=[spont1_IBIpix3; cont1_IBIpix3; drug1_IBIpix3; drug2_IBIpix3; drug3_IBIpix3; drug4_IBIpix3];
...
title('IBIs for 08/04/09 dish4 at pix3', 'Fontsize',14)
ylabel('IBI [s]')
xlabel('beat number analyzed')
ylim([0 2.5]);
...
allIBIpix4=[spont1_IBIpix4; cont1_IBIpix4; drug1_IBIpix4; drug2_IBIpix4; drug3_IBIpix4; drug4_IBIpix4];
...
title('IBIs for 08/04/09 dish4 at pix4', 'Fontsize',14)
ylabel('IBI [s]')
xlabel('beat number analyzed')
ylim([0 2.5]);
