...
[SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/spont.da');
...
for c=2:3;
    if c==2;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/spont01.da');
    end
    if c==3;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/spont02.da');
    end
...
for c=4:6
    if c==4;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/control.da');
    end
    if c==5;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/control01.da');
    end
    if c==6;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/control02.da');
    end
    [IBI1, IBIdoc1, time1, timedoc1, meanIBI1, meanIBIdoc1, stdIBI1, stdIBIdoc1, IBI2, IBIdoc2, time2, timedoc2, meanIBI2, meanIBIdoc2, stdIBI2, stdIBIdoc2, IBI3, IBIdoc3, time3, timedoc3, meanIBI3, meanIBIdoc3, stdIBI3, stdIBIdoc3, IBI4, IBIdoc4, time4, timedoc4, meanIBI4, meanIBIdoc4, stdIBI4, stdIBIdoc4]=IBI_multipixel_analysis2(SF1, [30 60], [20 20], [30 35], [20 18], 30, 30, 30, 30, 0.4);
...
for c=7:28
    if c==7;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol.da');
        threshs = [25 25 25 25];
    end
    if c==8;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol01.da');
        threshs = [30 30 40 30];
    end
    if c==9;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol02.da');
        threshs = [50 50 50 50];
    end
    if c==10;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol03.da');
        threshs = [30 30 30 30];
    end
    if c==11;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol04.da');
        threshs = [30 30 30 30];
    end
    if c==12;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol06.da');
        threshs = [30 30 30 30];
    end
    if c==13;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol07.da');
        threshs = [30 30 30 30];
    end
    if c==14;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol08.da');
        threshs = [30 30 30 30];
    end
    if c==15;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol09.da');
        threshs = [30 30 30 30];
    end
    if c==16;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol10.da');
        threshs = [30 30 30 30];
    end
    if c==17;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol11.da');
        threshs = [30 30 30 30];
    end
    if c==18;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol12.da');
        threshs = [30 30 30 30];
    end
    if c==19;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol13.da');
        threshs = [30 30 30 30];
    end
    if c==20;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol14.da');
        threshs = [30 30 30 30];
    end
    if c==21;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol15.da');
        threshs = [30 30 30 30];
    end
    if c==22;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol16.da');
        threshs = [30 30 30 30];
    end
    if c==23;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol17.da');
        threshs = [30 30 30 30];
    end
    if c==24;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol18.da');
        threshs = [30 30 30 30];
    end
    if c==25;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/E40310p75umol19.da');
        threshs = [30 30 30 30];
    end
    if c==26;
...
for c=29:33
    if c==29;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/wash.da');
    end
    
    if c==30;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/wash01.da');
    end
    
    if c==31;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/wash02.da');
    end
    
    if c==32;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/wash03.da');
    end
    
    if c==33;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june17/Dish4/wash04.da');
    end
