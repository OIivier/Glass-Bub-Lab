...
[SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/spontnew.da');
...
for c=2:3;
    if c==2;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/spontnew01.da');
    end
    if c==3;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/spontnew02.da');
    end
...
for c=4:6
    if c==4;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/controlnew.da');
    end
    if c==5;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/controlnew01.da');
    end
    if c==6;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/controlnew02.da');
    end
    [IBI1, IBIdoc1, time1, timedoc1, meanIBI1, meanIBIdoc1, stdIBI1, stdIBIdoc1, IBI2, IBIdoc2, time2, timedoc2, meanIBI2, meanIBIdoc2, stdIBI2, stdIBIdoc2, IBI3, IBIdoc3, time3, timedoc3, meanIBI3, meanIBIdoc3, stdIBI3, stdIBIdoc3, IBI4, IBIdoc4, time4, timedoc4, meanIBI4, meanIBIdoc4, stdIBI4, stdIBIdoc4]=IBI_multipixel_analysis2(SF1, [30 60], [20 20], [30 35], [20 18], 30, 30, 30, 30, 0.4);
...
for c=7:28
    if c==7;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol.da');
        threshs = [25 25 25 25];
    end
    if c==8;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol01.da');
        threshs = [30 30 40 30];
    end
    if c==9;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol02.da');
        threshs = [50 50 50 50];
    end
    if c==10;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol03.da');
        threshs = [30 30 30 30];
    end
    if c==11;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol04.da');
        threshs = [30 30 30 30];
    end
    if c==12;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol06.da');
        threshs = [30 30 30 30];
    end
    if c==13;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol07.da');
        threshs = [30 30 30 30];
    end
    if c==14;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol08.da');
        threshs = [30 30 30 30];
    end
    if c==15;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol09.da');
        threshs = [30 30 30 30];
    end
    if c==16;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol10.da');
        threshs = [30 30 30 30];
    end
    if c==17;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol11.da');
        threshs = [30 30 30 30];
    end
    if c==18;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol12.da');
        threshs = [30 30 30 30];
    end
    if c==19;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol13.da');
        threshs = [30 30 30 30];
    end
    if c==20;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol14.da');
        threshs = [30 30 30 30];
    end
    if c==21;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol15.da');
        threshs = [30 30 30 30];
    end
    if c==22;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol16.da');
        threshs = [30 30 30 30];
    end
    if c==23;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol17.da');
        threshs = [30 30 30 30];
    end
    if c==24;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol18.da');
        threshs = [30 30 30 30];
    end
    if c==25;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol19.da');
        threshs = [30 30 30 30];
    end
    if c==26;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol20.da');
        threshs = [30 30 30 30];
    end
    if c==27;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p75umol21.da');
        threshs = [65 65 65 65];
    end
...
for c=29:50
    if c==29;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol.da');
    end
    
    if c==30;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol01.da');
    end
    
    if c==31;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol02.da');
    end
    
    if c==32;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol03.da');
    end
    
    if c==33;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol04.da');
    end
    
    if c==34;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol05.da');
    end
    
    if c==35;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol06.da');
    end
    
    if c==36;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol07.da');
    end
    
    if c==37;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol08.da');
    end
    
    if c==38;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol09.da');
    end
    
    if c==39;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol10.da');
    end
    
    if c==40;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol11.da');
    end
    
    if c==41;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol12.da');
    end
    
    if c==42;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol13.da');
    end
    
    if c==43;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol14.da');
    end
    
    if c==44;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol15.da');
    end
    
    if c==45;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol16.da');
    end
    
    if c==46;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol17.da');
    end
    
    if c==47;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol18.da');
    end
    
    if c==48;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol19.da');
    end
    
    if c==49;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol20.da');
    end
    
    if c==50;
        [SF1] = daRead7('/cnd0/home/gabriels/Desktop/Experiments/june24/Dish1/E40310p8125umol21.da');
    end
    
    [IBI1, IBIdoc1, time1, timedoc1, meanIBI1, meanIBIdoc1, stdIBI1, stdIBIdoc1, IBI2, IBIdoc2, time2, timedoc2, meanIBI2, meanIBIdoc2, stdIBI2, stdIBIdoc2, IBI3, IBIdoc3, time3, timedoc3, meanIBI3, meanIBIdoc3, stdIBI3, stdIBIdoc3, IBI4, IBIdoc4, time4, timedoc4, meanIBI4, meanIBIdoc4, stdIBI4, stdIBIdoc4]=IBI_multipixel_analysis2(SF1, [30 60], [20 20], [30 35], [20 18], 80, 80, 80, 80, 0.4);
   
    allIBIpix1w=[allIBIpix1w; IBIdoc1;];
    allIBIpix2w=[allIBIpix2w; IBIdoc2;];
    allIBIpix3w=[allIBIpix3w; IBIdoc3;];
    allIBIpix4w=[allIBIpix4w; IBIdoc4;];
end
