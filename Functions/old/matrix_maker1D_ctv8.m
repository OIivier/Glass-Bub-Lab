function [f1,f2]=matrix_maker1D_ctv8(f);

lx=7; % how many sequential IBIs the code outputs for each stimulus phase.
...
f2=f1;
f2(3,:)=f1(3,:)/f1(2,1)
f2(4,:)=(f1(3,:)+f1(4,:))/f1(2,1)
f2(5,:)=(f1(5,:)+f1(4,:)+f1(3,:))/f1(2,1)
