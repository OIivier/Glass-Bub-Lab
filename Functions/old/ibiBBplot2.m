function [IBIdoc,meanIBIdoc,stdIBIdoc]=ibiBBplot2(N,xcord,ycord,thresh,threshdoc,yLim)
...
%Shajahan modified it be removing extra outputs.
...
ylabel('Zero-meaned Light intensity','Fontsize',14);
